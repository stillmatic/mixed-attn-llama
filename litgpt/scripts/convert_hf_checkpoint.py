...
def copy_weights_hf_qwen2(
    ...
    if progress_per_file is not None:
        progress_per_file = progress_per_file / max(1, len(hf_weights) + len(qkv_weights) + len(qkv_biases))
...
def convert_hf_checkpoint(
    ...
    *,
    ...
    # TODO: decide whether we need it as a separate function
        ...
        qkv_weights = {}
        qkv_biases = {}
        copy_fn = partial(copy_weights_hf_qwen2, config, qkv_weights, qkv_biases)
